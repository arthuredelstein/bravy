...
const base::Feature ${constantName(camel)}{
  ...
  {file: "chromium_src/third_party/blink/public/common/features.h",
   create: (camel) => `BLINK_COMMON_EXPORT extern const base::Feature ${constantName(camel)};`,
   insertBefore: `\n}  // namespace features
}  // namespace blink`}
];
...
const insertInFile = (filePath, insertBefore, text) => {
  ...
  contents2 = contents.replace(insertBefore, text + insertBefore);
...
// The main function. Take a FeatureFlagName in camel caese and edit the
